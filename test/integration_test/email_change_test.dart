...
void main(){
  ...
  group('Profile Page – Email change test', () {
    testWidgets('Account Settings dialog shows Email field and default email when unauthenticated', (tester) async {
      ...
      // find Email TextField in dialog
      final emailFieldFinder = find.byWidgetPredicate((w) => w is TextField && w.decoration is InputDecoration && (w.decoration as InputDecoration).labelText == 'Email');
      expect(emailFieldFinder, findsOneWidget);

      final TextField emailField = tester.widget<TextField>(emailFieldFinder);
      // 未登录时，Email 输入框初始值应为空
