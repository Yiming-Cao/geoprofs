...
void main(){
  ...
  group('Profile Page – Password change test', () {
    testWidgets('Account Settings dialog shows New Password field and shows Confirm Password after typing', (tester) async {
      ...
      // find New Password TextField in dialog
      final passwordFieldFinder = find.byWidgetPredicate((w) => w is TextField && w.decoration is InputDecoration && (w.decoration as InputDecoration).labelText == 'New Password');
      expect(passwordFieldFinder, findsOneWidget);

      // enter a password and ensure Confirm Password appears
      await tester.enterText(passwordFieldFinder, 's3cret');
      await tester.pumpAndSettle();
